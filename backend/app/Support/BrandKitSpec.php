        ...
        $all = [
            ...
            [
                ...
                'place_prompt' => 'Image 1 is the product mockup photo: a blank barista stencil card lying next to '
                    ...
                    .'make ONLY these TWO additions: (1) DIE-CUT the silhouette of the logo in image 2 out of the '
                    .'stencil card\'s face — the logo-shaped hole is EMPTY, a true see-through opening: you look '
                    .'STRAIGHT THROUGH the card to the counter surface visible beneath it, exactly like the card\'s '
                    .'existing rectangular grip hole. The hole contains NOTHING — no powder, no colour, no fill, '
                    .'no logo artwork. A light halo of cocoa powder rests on the card\'s metal face AROUND the '
                    .'hole (as if the stencil was just used), but NEVER inside the hole itself; (2) dust the SAME logo silhouette in cocoa powder onto the centre of the coffee\'s '
