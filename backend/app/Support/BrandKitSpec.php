    ...
    public static function products(): array
    {
        $all = [
            ...
            [
                ...
                'place_prompt' => 'Image 1 is the product mockup photo: a modular hexagon LED panel wall mounted '
                    .'above a desk. Image 2 is a brand logo. Do NOT modify the photo — keep the room, the wall, the '
                    .'camera angle and framing, the desk with its objects and plant, the power cable and the '
                    .'lighting EXACTLY as in image 1 — and change ONLY the hexagon mosaic itself: rearrange the '
                    .'small hexagonal tiles so their overall silhouette is DIE-CUT to the SHAPE of the logo in '
                    .'image 2 — the mosaic is SOLID: the ENTIRE inside of the logo\'s shape is completely paved '
                    .'with tiles edge-to-edge (never just an outline or ring of tiles with an empty middle), and '
                    .'the stepped honeycomb contour hugs the logo\'s outline as closely as the tile grid allows, '
                    .'so the wall piece IS the logo built from hexagons. Recolour the tiles to the brand\'s own colours taken from the logo (one colour or a '
                    .'tasteful blend), and keep the soft glow halo on the wall matching that colour. IMPORTANT: use '
                    .'ONLY the logo\'s icon/symbol/graphic mark and STRIP AWAY any text or wordmark entirely; only '
                    .'if the logo is purely a text wordmark with no icon, build the mosaic from its lettering '
                    .'silhouette. Do NOT keep the mosaic shape from image 1 — its silhouette must be entirely '
                    .'replaced by the logo\'s shape, at the same size and position on the wall. Everything else in '
                    .'the photo stays untouched. Photorealistic; output only the photo, no watermark, no text.',
            ...
            [
                ...
                'base_prompt' => 'A photorealistic café product photo shot from a high three-quarter angle on a '
                    ...
                    .'barista stencil card (a flat rectangular card with a rectangular grip cut-out near its bottom '
                    .'edge) lying flat — the card face is solid and BLANK with NO logo cut-out, NO engraving and NO '
                    .'powder on or around it; on the right, a cappuccino in a grey-blue ceramic cup on a matching '
                    .'saucer, its golden-brown crema smooth and completely UNTOUCHED — no dusting, no latte art, no '
                    .'marks of any kind. Nothing else on the counter. Photorealistic, crisp focus, no watermark, no text.',
                'place_prompt' => 'Image 1 is the product mockup photo: a blank barista stencil card lying next to '
                    .'a cappuccino with a smooth untouched crema, shot from a high three-quarter angle. Image 2 is '
                    .'a brand logo. Do NOT '
                    .'modify the photo — keep the counter, the card\'s position and size, the cup, the saucer, the '
                    .'crema colour, the camera angle, framing and lighting EXACTLY as in image 1 — and '
                    .'make ONLY these TWO additions: (1) DIE-CUT the COMPLETE outer silhouette of the logo in '
                    .'image 2 out of the stencil card\'s face — the material inside that silhouette is removed '
                    .'ENTIRELY — the cut piece has been taken out and DISCARDED, it is NOT in the photo — leaving '
                    .'ONE clean continuous see-through opening: you look STRAIGHT THROUGH the card, and the '
                    .'counter\'s speckled stone texture CONTINUES seamlessly through the opening, rendered '
                    .'exactly the way the card\'s existing rectangular grip hole shows it. NOTHING remains inside '
                    .'the opening — no cut piece resting in place, no metal islands, bridges, slivers or fragments '
                    .'of the logo\'s inner details (inner details show only in the crema dusting, never in the '
                    .'stencil), and no powder, colour or fill in the hole. A light halo of cocoa powder rests on '
                    .'the card\'s metal face AROUND the opening (as if the stencil was just used), but NEVER '
                    .'inside it; (2) dust the SAME logo silhouette in cocoa powder onto the centre of the coffee\'s '
                    .'crema, dusted SOLID — the silhouette fully filled with powder (never just an outline with an '
                    .'empty middle) — crisp-edged and clearly recognisable, exactly as if sifted through that stencil. Both '
                    .'marks must reproduce the logo in image 2 EXACTLY — same silhouette, shapes and proportions, '
                    .'never redrawn, simplified or replaced with a generic shape. IMPORTANT: use ONLY the logo\'s '
                    .'icon/symbol/graphic mark and OMIT any text or wordmark entirely; only if the logo is purely a '
                    .'text wordmark, use its lettering. If the logo has several separate shapes, cut and dust them '
                    .'all in the same arrangement. Everything else in the photo stays untouched. Output only the '
                    .'photo — no watermark, no extra text.',
