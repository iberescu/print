        ...
        $all = [
            ...
            [
                ...
                'place_prompt' => 'Image 1 is the product mockup photo: a blank barista stencil card lying next to '
                    ...
                    .'stencil card\'s face — a clean cut-out in the middle of the card whose holes reveal ONLY the '
                    .'dark counter surface through them (the holes are empty air: never coloured, filled, painted '
                    .'or showing the logo\'s colours), with a light dusting of cocoa powder over and around the '
                    .'cut-out as if the stencil was just used; (2) dust the SAME logo silhouette in cocoa powder onto the centre of the coffee\'s '
