        ...
        $all = [
            ...
            [
                ...
                'place_prompt' => 'Image 1 is the product mockup photo: a blank barista stencil card lying next to '
                    .'a cappuccino with a smooth untouched crema, shot top-down. Image 2 is a brand logo. Do NOT '
                    .'modify the photo — keep the counter, the card\'s position and size, the cup, the saucer, the '
                    .'crema colour, the top-down camera angle, framing and lighting EXACTLY as in image 1 — and '
                    ...
                    .'crema, crisp-edged and clearly recognisable, exactly as if sifted through that stencil. Both '
