...
<template>
    <div class="rounded-2xl border border-paper-300 bg-white p-4 shadow-sm sm:p-5">
        <div class="flex items-center gap-2.5">
            ...
            <p v-if="qualifies" class="text-sm font-semibold text-brand-700 sm:text-base">🎉 Your order qualifies for free Economy shipping!</p>
            <p v-else class="text-sm text-ink/75 sm:text-base">Your order is <strong class="text-ink">{{ money(remaining) }}</strong> away from free Economy shipping.</p>
        </div>
