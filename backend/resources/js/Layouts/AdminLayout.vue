    ...
    <div class="flex min-h-screen bg-paper-200 text-ink">
        ...
        <aside class="fixed inset-y-0 left-0 hidden w-60 flex-col bg-navy text-paper md:flex">
            ...
            <nav class="flex-1 space-y-1 px-3 py-2 text-sm">
                ...
                <Link href="/admin/affiliates" class="flex items-center gap-3 rounded-lg px-3 py-2.5 font-medium transition" :class="isActive('/admin/affiliates') ? 'bg-white/15 text-white' : 'text-paper/70 hover:bg-white/10 hover:text-white'">
