...
const faq = [
    ...
    { q: 'What does the ad look like?', a: 'A quiet card in your page\'s flow: the visitor\'s own logo printed on four real products, one line of copy and a button. You saw a live one at the top of this page.' },
    { q: 'Who is this for?', a: 'Products whose users have a logo or a website: site builders, business-formation tools, hosting panels, directory listings, invoicing apps. If your users run small businesses, their logo is already in your product.' },
...
const steps = [
    ...
    { n: '2', title: 'Pass the logo you already have', text: 'Your users uploaded a logo or registered a domain in your product. Hand the widget that URL and our print engine does the rest.' },
    { n: '3', title: 'Their logo appears on real products', text: 'Business cards, shirts, mugs, totes — rendered server-side in about 30 seconds, shown as a clean ad card that links to our shop.' },
...
<template>
    <Head title="Affiliate Program — Earn $15–20 CPM" />
    <StoreLayout>
            ...
            <div class="relative mx-auto grid max-w-7xl items-center gap-12 px-6 py-16 sm:px-8 sm:py-20 lg:grid-cols-[1.05fr_1fr]">
                <div>
                    ...
                    <h1 class="mt-4 font-display text-4xl font-extrabold leading-[1.05] tracking-tight sm:text-5xl">
                        Your users' logos.<br />Our products.<br /><span class="text-lime-accent">Your ad revenue.</span>
                    </h1>
                    <p class="mt-5 max-w-lg text-lg text-white/70">
                        Embed one widget. It takes the logo your users already gave you and shows it printed on real
                        products — an ad made from their own brand. We pay <strong class="text-lime-accent">$15–20 per 1000 views</strong>.
                    </p>
                    ...
                    <div class="overflow-hidden rounded-2xl border border-white/10 bg-white shadow-2xl shadow-black/40">
                        ...
                        <div class="p-4">
                            ...
                            <p class="mt-3 text-center text-xs text-ink/45">
                                This is the real widget rendering a sample logo through our print engine right now — first products in ~30 s.
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <section class="mx-auto max-w-7xl px-6 py-14 sm:px-8 sm:py-16">
            <div class="max-w-2xl">
                ...
                <h2 class="mt-2 font-display text-3xl font-bold tracking-tight sm:text-4xl">From their logo to your revenue in four steps</h2>
            </div>
            ...
            <div class="mx-auto grid max-w-7xl items-center gap-10 px-6 py-14 sm:px-8 sm:py-16 lg:grid-cols-2">
                ...
                <div>
                    ...
                    <div class="mt-4 space-y-4 leading-relaxed text-ink/65">
                        <p>Generic banners get ignored. But show someone <em>their own logo</em> on a stack of business cards and
                        a shirt, and they stop scrolling — it's the product photo of a thing they already want to exist.</p>
                        <p>Our print engine renders every visitor's products server-side, individually. When they click through,
                        the whole shop stays personalised — their logo follows them onto product pages, the designer and the cart.</p>
        ...
        <section class="mx-auto max-w-7xl px-6 pb-14 sm:px-8">
            <div class="grid items-center gap-10 lg:grid-cols-2">
                <div>
                    ...
                    <h2 class="mt-2 font-display text-3xl font-bold tracking-tight">A card in your layout, not a banner fighting it</h2>
