    ...
    <StoreLayout>
        ...
        <section class="bg-brand-50">
            <div class="mx-auto flex max-w-3xl flex-col items-center gap-4 px-6 py-12 text-center sm:px-8">
                <h2 class="font-display text-2xl font-bold tracking-tight text-ink sm:text-3xl">Printing your QR code? Get 20% off</h2>
                <p class="max-w-xl text-ink/60">Drop your email and we'll send a code for 20% off your first order — business cards, stickers, signs, anything.</p>
                <NewsletterSignup source="qr-tool" cta="Email my 20% off" />
            </div>
        </section>
