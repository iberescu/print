...
Route::get('/feed/rtbhouse-stores_v2.tsv', [FeedController::class, 'rtbhouseStores'])->name('feed.rtbhouse.stores');
Route::get('/feed/rtbhouse-stores.tsv', [FeedController::class, 'rtbhouseStores']);  // v1 path, same current feed
