...
MAIL_FROM_ADDRESS=${MAIL_FROM_ADDRESS:-support@runmyprint.com}
MAIL_FROM_NAME=RunMyPrint
...
GOOGLE_ADS_LABEL_PURCHASE=${GOOGLE_ADS_LABEL_PURCHASE:-}
GOOGLE_ADS_LABEL_LOGO=${GOOGLE_ADS_LABEL_LOGO:-}
GOOGLE_ADS_LABEL_CART=${GOOGLE_ADS_LABEL_CART:-}
ENVEOF
